...
<body>
    ...
    <p>
        ...
        <a href="example1.php<?php echo prep_query_string(array('bootstrap' => 3)); ?>"<?php echo isset($_GET['bootstrap']) && $_GET['bootstrap'] == 3 ? ' class="active"' : ''; ?>>Bootstrap 3</a> looks or the
        <a href="example1.php<?php echo prep_query_string(array('bootstrap' => 4)); ?>"<?php echo isset($_GET['bootstrap']) && $_GET['bootstrap'] == 4 ? ' class="active"' : ''; ?>>Bootstrap 4</a> looks
        <br>
